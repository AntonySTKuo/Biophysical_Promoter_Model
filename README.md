...
1. **PAS model**, applied to PL<sub>C17</sub> and PL<sub>C16</sub> <br>
   Implementation: `scripts/ModelFit_PAS.py`

2. **PAS model**, applied to PL<sub>C16SB</sub> (single-batch) <br>
...
| `FigS09_C16SB.ipynb` | PAS model results for constitutive promoter library PL<sub>C16SB</sub> |
